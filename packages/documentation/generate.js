...
generator({
    input: {
        ...
        schemas: []
            .concat(require('../schemas/defs.json'))
            .concat(require('../schemas/vendors/json-schema-draft-04.json'))
            .concat(require('../schemas/vendors/openapi-v2-schema.json'))
            .concat(require('@ouest-france/schemas').rawSchemas),
